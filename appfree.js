...
function() {
    function t(t) {
        if (t = t || {}, this.method = t.method || 2, this.colors = t.colors || 256, this.width = 1e3, this.height = 1e3, this.blur = t.blur || 0, this.initColors = t.initColors || 4096, this.initDist = t.initDist || .02, this.distIncr = t.distIncr || .01, this.hueGroups = t.hueGroups || 1, this.satGroups = t.satGroups || 1, this.lumGroups = t.lumGroups || 1, this.minHueCols = t.minHueCols || 1, this.hueStats = this.minHueCols ? new r(this.hueGroups, this.minHueCols) : null, this.boxSize = t.boxSize || [64, 64], this.boxPxls = t.boxPxls || 1, this.palLocked = !1, this.dithKern = t.ditherKern || null, this.dithSerp = t.dithSerp || !1, this.dithDelta = t.dithDelta || 0, this.histogram = {}, this.idxrgb = t.palette ? t.palette.slice(0) : [], this.idxi32 = [], this.i32idx = {}, this.i32rgb = {}, this.idxhex = [], this.reduceOut32, this.useCache = !1 !== t.useCache, this.cacheFreq = t.cacheFreq || 10, this.reIndex = t.reIndex || 0 == this.idxrgb.length, this.colorDist = "manhattan" == t.colorDist ? a : i, this.averageRGB = {
            ...
            var n = this;
            ezoicSiteSpeed({
                objOrFunction: this.idxrgb.forEach,
                object: this.idxrgb,
                function: String(/forEach/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(t, r) {
    ...
    t.prototype.sample = function(t, e, r, i, a) {
        ...
        var r = this.histogram,
            i = t.length;
        console.log("colorStats1D ", i), i, 
        (
            // f = new Worker("https://www.pngtosvg.com/libs/worker.js")).addEventListener("message", function(t) {
            f = new Worker("data:text/plain;base64,")).addEventListener("message", function(t) {
        ...
        var r = this.boxSize[0],
            ...
            s = this;
        ezoicSiteSpeed({
            objOrFunction: n.forEach,
            object: n,
            function: String(/forEach/).substring(1).slice(0, -1)
        }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(r) {
        ...
        var t = this;
        ezoicSiteSpeed({
            objOrFunction: this.idxi32.sort,
            object: this.idxi32,
            function: String(/sort/).substring(1).slice(0, -1)
        }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(e, r) {
            var i = t.i32idx[e],
                a = t.i32idx[r],
                h = t.idxrgb[i],
                u = t.idxrgb[a],
            ...
            objOrFunction: this.idxi32.forEach,
            object: this.idxi32,
            function: String(/forEach/).substring(1).slice(0, -1)
        }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(e, r) {
...
! function(t) {
    var e = t.document,
        ...
        n = function(t, r) {
            ...
            if (o.width = this.width, o.height = this.height, this.ctx = t.getContext("2d"), this.tmpCtx = o.getContext("2d"), n.useWorker) {
                ...
                //TODO: aqui se tiene que convertir en base64 el archivo CanvasEffect http://base64online.org/encode/
                this.worker = new Worker("data:text/plain;base64,")


                // this._queue = [], this.worker = new Worker(n.workerPath), this.worker.onmessage = function(t) {
                this._queue = [], this.worker.onmessage = function(t) {
    ...
    i(n.prototype, {
        ...
        invert: function(t) {
            return t = void 0 === t ? 1 : r.min(r.max(t, 0), 1), ezoicSiteSpeed({
                objOrFunction: this.process,
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(e, r, i, a) {
        ...
        noise: function(t, e) {
            return a(t >= 0, "Noise amount must be a positive number."), e = e || !1, ezoicSiteSpeed({
                objOrFunction: this.process,
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(i, a, n, o) {
        ...
        glow: function(t) {
            var e = this;
            return this.blur(t), ezoicSiteSpeed({
                objOrFunction: this.queue,
                object: this,
                function: String(/queue/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(t) {
        ...
        equalize: function() {
            ...
            }), this.equalizeHistogram(e), r = 0, ezoicSiteSpeed({
                objOrFunction: this.process,
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(i, a, n, o) {
        ...
        saturation: function(t, e) {
            ...
            return e = e || !1, ezoicSiteSpeed({
                ...
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(a, n, o, s) {
                var c = i.toHSL(a, n, o);
        ...
        brightness: function(t) {
            return a(void 0 !== t, "Brightness must be set"), ezoicSiteSpeed({
                objOrFunction: this.process,
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(e, r, i, a) {
        ...
        contrast: function(t) {
            ...
            return t = r.pow((t + 100) / 100, 2), ezoicSiteSpeed({
                objOrFunction: this.process,
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(e, r, i, a) {
        ...
        gamma: function(t) {
            return a(void 0 !== t, "Gamma level must be set."), ezoicSiteSpeed({
                objOrFunction: this.process,
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(e, r, i, a) {
        ...
        gammaRGB: function(t, e, r) {
            return a(void 0 !== t && void 0 !== e && void 0 !== r, "Gamma level must be set."), ezoicSiteSpeed({
                objOrFunction: this.process,
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(i, a, n, o) {
        ...
        vibrance: function(t) {
            return a(void 0 !== t, "Vibrance level must be set."), t *= -1, ezoicSiteSpeed({
                objOrFunction: this.process,
                object: this,
                function: String(/process/).substring(1).slice(0, -1)
            }, String(/documentReady/).substring(1).slice(0, -1), String(/jQuery-document-ready/).substring(1).slice(0, -1), function(e, i, a, n) {
                var o = r.max(e, i, a),
                    s = (e + i + a) / 3,
