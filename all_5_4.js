...
v4rr.w2(0);
holder["addEventListener"]("dragover", fileDragHover, !v4rr.K2("1", 0));
v4rr.D2(1);
holder["addEventListener"]("dragleave", fileDragHover, !v4rr.K2("1", 1));
holder["addEventListener"]("drop", fileSelectHandler, !+"1");
holder["style"]["display"] = "block";

function download(J, S) {
    var H;
...
function generate() {
    ...
    (ofx = new CanvasEffects(document["getElementById"]("canvas"), function() {
        ...
        Z5["workerPath"] = "CanvasEffects.worker.min.js";
        // Z5["workerPath"] = "https://www.pngtosvg.com/libs/CanvasEffects.worker.min.js";
    ...
    G["onload"] = function(k) {
        F ? ($(".block")["css"]("display", "block"), imgURL = k["target"]["result"], palette = [], $("#pickedcolorlist")["empty"](), (loadImg = new Image())["crossOrigin"] = "Anonymous", loadImg["onload"] = function() {
            ...
            (fx = new CanvasEffects(document["getElementById"]("effectcanvas"), function() {
                ...
                c5 = {};
                c5["useWorker"] = !0;
                c5["workerPath"] = "CanvasEffects.worker.min.js";
                return c5;
            } ["apply"](this, arguments)))["load"](imgURL, function() {
...
function getImageFormUrl(v) {
    ...
    loadImg["onload"] = function() {
        ...
        (fx = new CanvasEffects(document["getElementById"]("effectcanvas"), function() {
            ...
            Y5["workerPath"] = "CanvasEffects.worker.min.js";
            return Y5;
        } ["apply"](this, arguments)))["load"](imgURL, function() {
            var o9, S9, Q9;
            o9 = +"679855034";
